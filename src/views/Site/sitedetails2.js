    ...
    <Nav tabs>
      ...
      <Button   style={{display: 'flex', justifyContent: 'right',color:"white",backgroundColor:"#81163F" }} className="float-right" onClick={this.onClickButtonaddpic}> Add PIC</Button>
                ...
                <tbody>
                    ...
                    <th>1</th>
                    <th>Fuad Alili</th>
                    <th>Ahmadfuad@gmail.com</th>
                    <th>0111111111</th>
                    <th><Button style={{backgroundColor:"#C996A9", color:"#81163F"}}>Main PIC</Button></th>
                    <th>
                    <a href='#!' style={{ paddingInline:'10px', color:"#81163F", width:"10px"}} onClick={this.onClickButtoneditpic} className='icon-note'> </a>{' '}
                    <a href='#!' style={{ paddingInline:'10px', color:"#81163F",width:"10px"}}  onClick={this.onClickButtondeletepic} className='icon-trash'> </a></th>
                </tbody>
          ...
          <Modal center open={this.state.openModaleditpic} onClose={this.onCloseModaleditpic}>
                ...
                <div className="title">
                  ...
                  <text className='tbl2'>Delete the certain PIC with all the details.</text>
                  </div>
                
                
                
                <div className='footer button'>
              <Button  style={{color:"white",backgroundColor:"#81163F"}} onClick={this.onClickButtondeletepic}>No, Keep PIC</Button> 
            ...
            <Row>
              ...
              <Button style={{display: 'flex', justifyContent: 'right',color:"white",backgroundColor:"#81163F" }} className="float-right" onClick={this.onClickButtonaddzone}> Add Zone</Button>
                ...
                <tbody>
                    ...
                    <th>5.23658</th>
                    <th>
                    <a href='#!' style={{ paddingInline:'10px'}} onClick={this.onClickButtoneditcp} className='icon-note'> </a>{' '}
                    <a href='#!' color="#81163F"  onClick={this.onClickButtondeletecp} className='icon-trash'> </a></th>
                </tbody>
        ...
        <TabContent activeTab={this.state.activeTab1}>
          ...
          <TabPane tabId="5">
            <Row>
              ...
              <Button   style={{color:"white",backgroundColor:"#81163F"}} type = 'submit'   >Submit</Button>
              </FormGroup>
            </Row>
          </TabPane>
                ...
                <div className='tbl2'></div>
                <Button  style={{display: 'flex', color:"white",backgroundColor:"#81163F",justifyContent: 'right' }} className="float-right" onClick={this.onClickButtonaddcp}> Add Checkpoint</Button>
              ...
              <Modal center open={this.state.openModaleditcp} onClose={this.onCloseModaleditcp}>
                ...
                <div className="title">
                  ...
                  <text  className='tbl2'>Delete the certain checkpoint with all the details.</text>
                  </div>
            ...
            <Modal size="sm"center  open={this.state.openModaldeletezn} onClose={this.onCloseModaldeletezn}>
                ...
                <div className="title">
                  ...
                  <text  className='tbl2'>Delete a zone will permenently delete the zone and all the corresponding checkpoints.</text>
                  </div>
          ...
          <TabPane tabId="3">
              ...
              <Button  style={{display: 'flex', justifyContent: 'right' ,color:"white",backgroundColor:"#81163F"}} className="float-right" onClick={this.onClickButtonadddv}> Add Device</Button>
                ...
                <tr>
                    <th>No</th>
                    <th>Application Serial Number</th>
                ...
                <tbody>
                    ...
                    <th>BH100HU2345</th>
                    <th>www.EE.com.y</th>
                    <th>summons and geofencing</th>
                    <th>01111111111</th>
                    <th><a href='#!' style={{ paddingInline:'10px',color:"#81163F", width:"8px"}} onClick={this.onClickButtonview} className='icon-info'> </a>{' '}
                    <a href='#!' style={{ paddingInline:'10px',color:"#81163F", width:"8px"}}onClick={this.onClickButtoneditdv} className='icon-note'> </a>{' '}
                    <a href='#!' style={{ paddingInline:'10px',color:"#81163F", width:"8px"}}  onClick={this.onClickButtondeletedv} className='icon-trash'> </a></th>
                </tbody>
               ...
               <Modal center open={this.state.openModaleditdv} onClose={this.onCloseModaleditdv}>
                ...
                <text  className='tbl2'>Delete the certain device with all te details.</text>
                </div>
